$vm.module_list={
    ...
    event_record:                ['20003773','.../modules/event_record.html','2'],
    daily:                       ['--------','.../modules/daily.html','2',  'event_record'],
    weekly:                      ['--------','.../modules/weekly.html','2', 'event_record','daily'],
    monthly:                     ['--------','.../modules/monthly.html','2','event_record','daily'],
}
//--------------------------------------------------------
